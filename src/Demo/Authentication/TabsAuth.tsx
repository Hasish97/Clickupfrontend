    ...
    return (
      <>
        ...
        <div className="auth-wrapper">
          <div className="auth-content text-center container">
            <img src={logoDark} alt="" className="img-fluid mb-4" />
            <div className="card">
              <div className="row no-gutters row-bordered">
                <div className="col-md-6">
                  <h5 className="text-center text-muted font-weight-normal py-4 px-4 px-sm-5 m-0">
                ...
                <div className="col-md-6 border-left border-light">
                  ...
                  <div className="px-4 px-sm-5 pt-4 pb-5 pb-sm-5">
                    ...
                    <button className="btn btn-primary btn-block mb-4 rounded-pill">
                      Sign up
                    </button>
                  </div>
                </div>
