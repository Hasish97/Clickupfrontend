            ...
            <Card>
              <Card.Body className="p-30">
                <div className="d-flex pt-3 pb-2 no-block">
                  <div className="align-self-center mr-5 ml-4">
                    <img src={note} alt="" title="" width="55" />
                  </div>
                  <div className="align-slef-center mr-auto">
                    <h2 className="m-b-2 text-uppercase font-30 font-medium lp-5 text-danger">
                      459
                    </h2>
          ...
          <Col lg={4} md={6}>
            <Card>
              <Card.Body className="p-30">
                <div className="d-flex pt-3 pb-2 no-block">
                  <div className="align-self-center mr-5 ml-4">
                    <img src={badge} alt="" title="" width="55" />
                  </div>
                  <div className="align-slef-center mr-auto">
                    <h2 className="m-b-2 text-uppercase font-30 font-medium lp-5 text-primary">
                      $165
                    </h2>
          ...
          <Col lg={4} md={12}>
            <Card>
              <Card.Body className="p-30">
                <div className="d-flex pt-3 pb-2 no-block">
                  <div className="align-self-center mr-5 ml-4">
                    <img src={users} alt="" title="" width="55" />
                  </div>
                  <div className="align-slef-center mr-auto">
                    <h2 className="m-b-2 text-uppercase font-30 font-medium lp-5 text-warning">
                      2167
                    </h2>
            ...
            <Card className="panel-main o-income panel-refresh">
              <Card.Body className="panel-wrapper">
                ...
                <ul className="list-inline m-b-30 text-uppercase lp-5 font-medium font-14">
                  <li>
                    <i className="fas fa-square m-r-5 text-primary" /> Sales
                  </li>
                  <li>
                    <i className="fas fa-square m-r-5 text-danger" /> Orders
                  </li>
                  <li>
                    <i className="fas fa-square m-r-5 text-success" /> New
                    visitors{" "}
                  </li>
                </ul>
          ...
          <Col lg={6} md={12}>
            <Card className="panel-main o-income panel-refresh">
              <div>
                <Card.Body className="panel-wrapper">
                  <div className="d-flex m-b-10 no-block">
                    <h5 className="card-title m-b-3 mt-3 align-self-center">
                      Popular categories
                    </h5>
                    <div className="ml-auto text-muted-blue mt-3">
                      {" "}
                      <a
                        href={DEMO.BLANK_LINK}
                        className="pull-left text-muted-blue inline-block refresh mr-15"
                      >
                        {" "}
                    ...
                    <PerfectScrollbar>
                      <Table responsive className="color-table">
                        <tbody>
                          <tr>
                            <td>
                              <img src={product1} alt="" title="" />
                            </td>
                            <td>
                              Notebook Asus Aspire <br />
                              $375
                            </td>
                            <td>
                              <span className="font-24 text-primary">
                                $9 375
                              </span>{" "}
                              <br />
                              25 sales
              ...
              <Card.Body className="panel-wrapper">
                <div className="d-flex m-b-10 no-block">
                  ...
                  <div className="ml-auto text-light-blue">
                    ...
                    <a
                      href={DEMO.BLANK_LINK}
                      className="pull-left text-light-blue inline-block refresh mr-15"
                    >
                      {" "}
                      <i className="fas fa-sync" /> Update{" "}
                    </a>{" "}
                ...
                <ul className="list-inline m-t-30 m-b-20 weight-500 text-dark text-uppercase lp-5 font-medium font-12">
                  <li>
                    1. Ukraine <span className="text-danger">29.5%</span>
                  </li>
                  <li>
                    2. USA <span className="text-primary">29.5%</span>
                  </li>
                  <li>
                    3. Canada <span className="text-warning">29.5%</span>
                  </li>
                  <li>
                    4. Australia <span className="text-info">29.5%</span>
                  </li>
                  <li>
                    5. Russia <span className="text-purple">29.5%</span>
                  </li>
                </ul>
