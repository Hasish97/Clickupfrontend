            ...
            <Card className="panel-main o-income panel-refresh">
              <Card.Body className="panel-wrapper">
                <div className="d-flex m-b-10 no-block">
                  ...
                  <div className="ml-auto text-muted-blue">
                    {" "}
                    <a
              ...
              <Card.Body className="p-b-30">
                <div className="d-flex pt-3 p-b-20 no-block">
                  ...
                  <div className="align-self-center mr-auto">
                    <h2 className="m-b-0 text-uppercase f-18 font-medium lp-5">
                      Processes
                    </h2>
            ...
            <Card>
              <Card.Body className="p-b-30">
                <div className="p-t-20">
                  <h2 className="m-b-0 text-uppercase f-18 font-medium lp-5  float-left">
                    Latency
                  </h2>
                  ...
                  <Col lg={8} md={12}>
                    ...
                    <ul className="list-inline m-b-10 text-uppercase lp-5 font-medium font-12">
                      <li className="list-inline-item">
                        <i className="fa fa-square m-r-5 text-warning" /> CPU
                      </li>
                      <li className="list-inline-item">
                        <i className="fa fa-square m-r-5 text-danger" /> Memory
                      </li>
                      <li className="list-inline-item">
                        <i className="fa fa-square m-r-5 text-primary" /> Disc
                        (C: D:)
                      </li>
                    </ul>
                  ...
                  <Col lg={4} md={12}>
                    <div className="panel-main pl-5 m-b-10 no-block panel-refresh bordered-left-light bordered-css">
                      ...
                      <div className="block m-t-10 m-b-40">
                        <div className="cpu-div-left">
                          {" "}
                          <span className="block f-24 text-danger">
                            10%
                          </span>{" "}
                          Using{" "}
                        </div>
                        <div className="cpu-div-right pl-4">
                          {" "}
                          <span className="block f-24 text-primary">
                            2.98 GHz
                          </span>{" "}
                          Speed{" "}
                        </div>
                      ...
                      <hr />
                      <h5 className="card-title m-t-30 m-b-0 align-self-center">
                        Memory
                      </h5>
                      <div className="block m-t-10 m-b-40">
                        <div className="cpu-div-left">
                          ...
                          <tr>
                            ...
                            <td>
                              <a href={DEMO.BLANK_LINK}>
                                <i className="fas fa-trash-alt text-danger op-5" />
                              </a>
                            </td>
                          </tr>
                          <tr>
              ...
              <Card.Body className="p-10 panel-wrapper">
                <div className="d-flex m-t-10 p-l-10 m-b-10 no-block">
                  ...
                  <div className="ml-auto text-muted-blue">
                    ...
                    <a
                      href={DEMO.BLANK_LINK}
                      className="pull-left text-muted-blue inline-block refresh m-r-15"
                    >
                      <i className="fas fa-sync" />
                      Update
                    </a>
