...
type TaskManagerProjectState = {
  newTask?: boolean
};
class TaskManagerProject extends React.Component<{}, TaskManagerProjectState> {
  state = {
    newTask: false
  };
  render() {
        ...
        <Row className="align-items-center page-header">
          ...
          <Col md={8} className="text-right">
            <ul className="nav nav-tabs customtab pro-customtab">
              ...
              <li className="nav-item">
                {" "}
                <NavLink className="nav-link" to="/dashboard/project/details">
                  {" "}
                  <span>Details</span>
                </NavLink>{" "}
              </li>
        ...
        <Row>
          <Col>
            <Card>
              <Card.Body>
                <Modal
                  show={this.state.newTask}
                  onHide={() => this.setState({ newTask: false })}
                >
                  ...
                  <Modal.Body className="p-0">
                    <Table
                      responsive
                      className="color-table primary-table table2"
                    >
                      <tbody>
                        <tr>
                          <td>
                  ...
                  <Modal.Footer>
                    ...
                    <Button
                      variant="secondary"
                      onClick={() => this.setState({ newTask: false })}
                    >
                      Close
                    </Button>
                  </Modal.Footer>
                  ...
                  <Col md={9} sm={9}>
                    <div className="float-right d-none d-xl-inline-block d-lg-inline-block">
                      ...
                      <a
                        ...
                        className="float-right btn waves-effect waves-light btn-rounded btn-primary"
                      >
                        Add Task
                      </a>
                    </div>
                ...
                <div className="mt-3">
                  <ul className="list-inline m-b-30 text-uppercase lp-5 font-medium font-12">
                    <li>
                      <i className="fa fa-circle m-r-5 f-10 text-primary" /> New
                    </li>
                    <li>
                      <i className="fa fa-circle m-r-5 f-10 text-warning" /> In
                      process
                    </li>
                    <li>
                      <i className="fa fa-circle m-r-5 f-10 text-success" />{" "}
                      Done
                    </li>
                  </ul>
                </div>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <ul className="list-inline text-uppercase m-0 font-medium font-12">
                          <li>
                            <i className="fa fa-circle f-10 text-warning" />
                          </li>
                        </ul>
                      </td>
                    ...
                    <tr>
                      <td>
                        <ul className="list-inline  text-uppercase m-0  font-medium font-12">
                          <li>
                            <i className="fa fa-circle f-10 text-primary" />
                          </li>
                        </ul>
                      </td>
                      <td>Style guide</td>
                    ...
                    <tr>
                      <td>
                        <ul className="list-inline  text-uppercase m-0  font-medium font-12">
                          <li>
                            <i className="fa fa-circle f-10 text-success" />
                          </li>
                        </ul>
                      </td>
                      <td>Style guide</td>
                ...
                <div className="row">
                  <div className="col-md-6 page-n">
                    Show:{" "}
                    <a href={DEMO.BLANK_LINK} className="active">
                      10
                    </a>{" "}
                    <a href={DEMO.BLANK_LINK}>20</a>{" "}
                    <a href={DEMO.BLANK_LINK}>50</a>
                  </div>
