...
type MembersProjectState = {
  newTask?: boolean
};
class MembersProject extends React.Component<{}, MembersProjectState> {
  state = {
    newTask: false
  };
  render() {
                ...
                <Table responsive className="color-table primary-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div className="round-img">
                          <img src={avatar3} alt="user" className="" />
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div className="round-img">
                          <img src={avatar4} alt="user" className="" />
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div className="round-img">
                          <img src={avatar5} alt="user" className="" />
                        </div>
                      </td>
                      <td className="font-bold"> John Donovan </td>
                      <td>designer</td>
                    ...
                    <tr>
                      <td>
                        <div className="round-img">
                          <img src={avatar1} alt="user" className="" />
                        </div>
                      </td>
                      <td className="font-bold"> John Donovan </td>
                      <td>designer</td>
                    ...
                    <tr>
                      <td>
                        <div className="round-img">
                          <img src={avatar2} alt="user" className="" />
                        </div>
                      </td>
