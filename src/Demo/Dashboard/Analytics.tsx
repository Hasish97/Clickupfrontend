          ...
          <Col lg={12} md={12}>
            <Card className="panel-main o-income panel-refresh">
              <Card.Body className="panel-wrapper">
                ...
                <ul className="list-inline m-b-30 text-uppercase lp-5 font-medium font-12">
                  <li>
                    <i className="fa fa-square m-r-5 text-warning" /> Sales
                  </li>
                  <li>
                    <i className="fa fa-square m-r-5 text-pink" /> Orders
                  </li>
                  <li>
                    <i className="fa fa-square m-r-5 text-primary" /> New
                    visitors{" "}
                  </li>
                </ul>
          ...
          <Col lg={6} md={12}>
            <Card className="panel-main o-income panel-refresh">
              <Card.Body className="panel-wrapper">
                ...
                <ul className="list-inline m-b-30 text-uppercase lp-5 font-medium font-12">
                  <li>
                    <i className="fa fa-square m-r-5 text-primary" /> Male
                  </li>
                  <li>
                    <i className="fa fa-square m-r-5 text-warning" /> Female
                  </li>
                  <li>
                    <i className="fa fa-square m-r-5 text-purple" /> Undefined
                  </li>
                  <li>
                    <i className="fa fa-square m-r-5 text-success" /> Suits
                  </li>
                </ul>
