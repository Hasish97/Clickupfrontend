...
function atable() {
  ...
  function getOption(value: string, selected: string, label: string) {
    if (value === selected) {
...
class TaskList extends React.Component<{}, TaskListState> {
  ...
  handleClick = (e: React.MouseEvent<HTMLInputElement>) => {
    ...
    if ((e.target as HTMLInputElement).checked) {
      ...
      this.setState(prevState => {
        return {
          selectedTask: this.state.selectedTask.filter(
            item => item !== parseInt(clickedValue)
          )
        };
      });
    }
                ...
                <div className="new-task">
                  <div className="to-do-list mb-4">
                    <div className="checkbox-fade fade-in-primary">
                      <label
                        className={
                          selectedTask.findIndex(item => item === 1) > -1
                            ? "check-task done-task"
                            : "check-task"
                        }
                      >
                        <input
                  ...
                  <div className="to-do-list mb-4">
                    <div className="checkbox-fade fade-in-primary">
                      <label
                        className={
                          selectedTask.findIndex(item => item === 2) > -1
                            ? "check-task done-task"
                            : "check-task"
                        }
                      >
                  ...
                  <div className="to-do-list mb-4">
                    <div className="checkbox-fade fade-in-primary">
                      <label
                        className={
                          selectedTask.findIndex(item => item === 3) > -1
                            ? "check-task done-task"
                            : "check-task"
                        }
                      >
                  ...
                  <div className="to-do-list mb-4">
                    <div className="checkbox-fade fade-in-primary">
                      <label
                        className={
                          selectedTask.findIndex(item => item === 4) > -1
                            ? "check-task done-task"
                            : "check-task"
                        }
                      >
                  ...
                  <div className="to-do-list mb-4">
                    <div className="checkbox-fade fade-in-primary">
                      <label
                        className={
                          selectedTask.findIndex(item => item === 5) > -1
                            ? "check-task done-task"
                            : "check-task"
                        }
                      >
