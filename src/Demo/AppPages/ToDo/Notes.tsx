                  ...
                  <Col md={3}>
                    <Form.Group>
                      <div className="checkbox d-inline checkbox-fill checkbox-info">
                        ...
                        />
                        <Form.Label htmlFor="show-title" className="cr">
                          Show Title
                        </Form.Label>
                      </div>
                    </Form.Group>
                    <Form.Group>
                      <div className="checkbox d-inline checkbox-fill checkbox-info">
                        <Form.Control
                          ...
                          id="custom-color"
                          value="show_custom_colors"
                          defaultChecked={this.state.showCustomColors}
                          onChange={this.toggleValue}
                        />
                        <Form.Label htmlFor="custom-color" className="cr">
                          Custom Colors
                        </Form.Label>
                      </div>
                    </Form.Group>
                    <Form.Group>
                      <div className="checkbox d-inline checkbox-fill checkbox-info">
                        <Form.Control
                          ...
                          id="show-tape"
                          value="show_tape"
                          defaultChecked={this.state.showTape}
                          onChange={this.toggleValue}
                        />
                        <Form.Label htmlFor="show-tape" className="cr">
                          Show Tape
                        </Form.Label>
                      </div>
                    </Form.Group>
                    <Form.Group>
                      <div className="checkbox d-inline checkbox-fill checkbox-info">
                        <Form.Control
                          ...
                          id="show-output"
                          value="show_output"
                          defaultChecked={this.state.showOutput}
                          onChange={this.toggleValue}
                        />
                        <Form.Label htmlFor="show-output" className="cr">
                          Show Output
                        </Form.Label>
                      </div>
                    </Form.Group>
                    <Form.Group>
                      <div className="checkbox d-inline checkbox-fill checkbox-info">
                        <Form.Control
                          ...
                          id="show-footer"
                          value="show_title"
                          defaultChecked={this.state.showFooter}
                          onChange={this.toggleValue}
                        />
                        <Form.Label htmlFor="show-footer" className="cr">
                          Show Footer
                        </Form.Label>
                      </div>
                    </Form.Group>
                    <Form.Group>
                      <div className="checkbox d-inline checkbox-fill checkbox-info">
                        <Form.Control
                          ...
                          id="show-mock"
                          value="show_mock"
                          defaultChecked={this.state.showMock}
                          onChange={this.fetchMock}
                        />
                        <Form.Label htmlFor="show-mock" className="cr">
                          Load Mock Data
                        </Form.Label>
                      </div>
                    </Form.Group>
                  ...
                  <Col>
                    <div className="config">
                      <div
                        className="output"
                        style={{
                          display: this.state.showOutput ? "block" : "none"
                        }}
                      >
                        <h3>Output JSON</h3>
                        <hr />
