...
interface IStaticProps extends React.HTMLAttributes<Element> {
...
class Static extends Component<IStaticProps, {}> {
        ...
        <Row>
          <Col>
            <Card>
              ...
              <Card.Body>
                <p>
                  In Static Layout - Header & Sidebar is not fixed while
                  scrolling the page.
                </p>
                <div className="alert alert-info mb-0" role="alert">
                  <p className="mb-0">
                    It is best suited for those applications where you don't
                    need sidebar & header to be fixed while scrolling the page.
                  </p>
                </div>
                <h5 className="m-15">
