...
interface IFixedProps extends React.HTMLAttributes<Element> {
...
class Fixed extends Component<IFixedProps, {}> {
        ...
        <Row>
          <Col>
            <Card>
              ...
              <Card.Body>
                <p>
                  In Fixed Layout - Header & Sidebar being fixed while scrolling
                  the page.
                </p>
                <div className="alert alert-info mb-0" role="alert">
                  <p className="mb-0">
                    It is best suited for those applications where you need the
                    sidebar & header elements easily accessible every time when
                    you scroll the page.
                  </p>
                </div>
                <h5 className="m-15">
