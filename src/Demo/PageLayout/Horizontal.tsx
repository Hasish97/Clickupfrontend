...
interface IHorizontalProps extends React.HTMLAttributes<Element> {
  layout?: any;
...
class Horizontal extends Component<IHorizontalProps, {}> {
        ...
        <Row>
          <Col>
            <Card>
              ...
              <Card.Body>
                <p>
                  In RTL Horizontal Layout - Navigation bar is set to be in
                  Right-To-Left direction as a Horizontal way. It also
                  showing/hidden while scrolling up/down.
                </p>
                <div className="alert alert-info mb-0" role="alert">
                  <p className="mb-0">
                    RTL Horizontal Layout is mostly preferred by Arabic, Hebrew,
                    Persian, and Urdu languages which are written from right to
                    left.
                  </p>
                </div>
                <h5 className="m-15">
...
export default (connect(mapStateToProps, mapDispatchToProps)(Horizontal)) as any;
