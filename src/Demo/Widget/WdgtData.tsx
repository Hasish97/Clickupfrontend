...
class WdgtData extends React.Component<{}, WdgtDataState> {
  _element: any;
  state = {
    width: 100
  };
            ...
            <Card>
              ...
              <Card.Body>
                <div className="browser-card p-b-15 ">
                  ...
                  <label className="badge badge-primary rounded-pill float-right btn-browser">
                    50%
                  </label>
                </div>
                <div className="browser-card border-top p-t-15 p-b-15 ">
                  <p className="d-inline-block m-0 ">Mozila Firefox</p>
                  <label className="badge badge-danger rounded-pill float-right btn-browser">
                    12%
                  </label>
                </div>
                <div className="browser-card border-top p-t-15 p-b-15 ">
                  <p className="d-inline-block m-0 ">Apple Safari</p>
                  <label className="badge badge-warning rounded-pill float-right btn-browser">
                    23%
                  </label>
                </div>
                <div className="browser-card border-top p-t-15 p-b-15 ">
                  <p className="d-inline-block m-0 ">Internet Explorer</p>
                  <label className="badge badge-success rounded-pill float-right btn-browser">
                    17%
                  </label>
                </div>
                <div className="browser-card border-top p-t-15 p-b-15 ">
                ...
                <div className="browser-card border-top p-t-15">
                  ...
                  <label className="badge badge-primary rounded-pill float-right btn-browser mb-0">
                    28%
                  </label>
                </div>
              </Card.Body>
                ...
                <div className="card-notification">
                  <div className="card-noti-conatin">
                    ...
                    <p className="text-muted m-b-30">
                      jennifer sent you an attachament
                    </p>
                  </div>
                </div>
                <div className="card-notification">
                  <div className="card-noti-conatin">
                    ...
                    <p className="text-muted m-b-30">
                      Paul has sent a request for access to the project folder
                    </p>
                  </div>
                </div>
                <div className="card-notification">
                  <div className="card-noti-conatin">
                    ...
                    <p className="text-muted m-b-30">
                      Demin change the dedline on the project
                    </p>
                  </div>
                </div>
                <div className="card-notification">
                  <div className="card-noti-conatin">
                    ...
                    <p className="text-muted m-b-30">
                      jennifer invite you to join the project
                    </p>
                  </div>
                </div>
                <div className="card-notification">
                  <div className="card-noti-conatin">
                    ...
                    <p className="text-muted mb-1">
                      Josephine share a folder with you
                    </p>
                  </div>
                </div>
              </Card.Body>
                      ...
                      <tr>
                        ...
                        <td className="text-right">
                          <div ref={this._element}>
                            <Line
                              values={[0, 5, 0, 5, 7, 6, 5.5, 10, 8]}
                              fillColor="rgba(70, 128, 254,0.2)"
                              strokeColor="rgb(70, 128, 254)"
                      ...
                      <tr>
                        ...
                        <td className="text-right">
                          <div ref={this._element}>
                            <Line
                              values={[0, 5, 0, 5, 7, 6, 5.5, 10, 8]}
                              fillColor="rgba(252, 97, 128,0.2)"
                              strokeColor="rgb(252, 97, 128)"
                              width={this.state.width}
                              height={25}
                            />
                          </div>
                      ...
                      <tr>
                        ...
                        <td className="text-right">
                          <div ref={this._element}>
                            <Line
                              values={[0, 5, 0, 5, 7, 6, 5.5, 10, 8]}
                              fillColor="rgba(147, 190, 82,0.2)"
                              strokeColor="rgb(147, 190, 82)"
                              width={this.state.width}
                              height={25}
                            />
                          </div>
                      ...
                      <tr>
                        ...
                        <td className="text-right">
                          <div ref={this._element}>
                            <Line
                              values={[0, 5, 0, 5, 7, 6, 5.5, 10, 8]}
                              fillColor="rgba(255, 182, 77,0.2)"
                              strokeColor="rgb(255, 182, 77)"
                              width={this.state.width}
                              height={25}
                            />
                          </div>
                      ...
                      <tr>
                        ...
                        <td className="text-right">
                          <div ref={this._element}>
                            <Line
                              values={[0, 5, 0, 5, 7, 6, 5.5, 10, 8]}
                              fillColor="rgba(254, 138, 125,0.2)"
                              strokeColor="rgb(254, 138, 125)"
                              width={this.state.width}
                              height={25}
                            />
                          </div>
                ...
                <Table hover responsive>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href={DEMO.BLANK_LINK}>
                          <i className="feather icon-star-on  f-18 text-c-blue" />
                        </a>
                        <a href={DEMO.BLANK_LINK}>
                          <i className="feather icon-star-on f-18 text-muted" />
                        </a>
                        <a href={DEMO.BLANK_LINK}>
                          <i className="feather icon-star-on f-18 text-muted" />
                        </a>
                ...
                <Table hover responsive className="mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div className="task-contain">
                          <h6 className="bg-c-blue d-inline-block text-center">
                            U
                          </h6>
                    ...
                    <tr>
                      <td>
                        <div className="task-contain">
                          <h6 className="bg-c-red d-inline-block text-center w-10">
                            R
                          </h6>
                          <p className="d-inline-block m-l-20">
                    ...
                    <tr>
                      <td>
                        <div className="task-contain">
                          <h6 className="bg-c-yellow d-inline-block text-center">
                            L
                          </h6>
                    ...
                    <tr>
                      <td>
                        <div className="task-contain">
                          <h6 className="bg-c-green d-inline-block text-center">
                            A
                          </h6>
                          <p className="d-inline-block m-l-20">
                ...
                <Table hover responsive>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <a href={DEMO.BLANK_LINK}>
                          <img className="img-radius" src={avatar1} alt="" />
                        </a>
                        <p className="d-inline-block m-l-10 f-w-600">
                          Erwin Brown
                        </p>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <a href={DEMO.BLANK_LINK}>
                          <img className="img-radius" src={avatar2} alt="" />
                        </a>
                        <p className="d-inline-block m-l-10 f-w-600">
                          Joseph Villa
                        </p>
                    ...
                    <tr>
                      <td>
                        <a href={DEMO.BLANK_LINK}>
                          <img className="img-radius" src={avatar3} alt="" />
                        </a>
                        <p className="d-inline-block m-l-10 f-w-600">
                          Jekson Durk
                        </p>
                    ...
                    <tr>
                      <td>
                        <a href={DEMO.BLANK_LINK}>
                          <img className="img-radius" src={avatar4} alt="" />
                        </a>
                        <p className="d-inline-block m-l-10 f-w-600">
                          Erwin Brown
                        </p>
