        ...
        <Row>
          ...
          <Col xl={3} md={6}>
            <Card className="profile-view">
              <Card.Body>
                <h5>Profile views</h5>
                <strong className="text-center p-t-40 p-b-30 m-0 f-40 f-w-400 d-block">
                  828
                </strong>
                <Row>
            ...
            <Card className="widget-card-user">
              <Card.Body className="p-b-0">
                <div className="card-user">
                  ...
                  <p className="text-muted p-t-10 p-b-10 m-0">
                    ...
                    <Row>
                      ...
                      <Col sm={10}>
                        <div className="request-contain">
                          ...
                          <h6 className="text-muted f-w-400 p-b-10 p-t-10">
                            Standard scans
                          </h6>
            ...
            <Card className="card-contact-box ">
              <Card.Body>
                <div className="card-contain text-center ">
                  ...
                  <h6 className="f-w-400 f-20 p-b-5 m-0 p-t-15 ">
                    Gregory Johan
                  </h6>
                  <a href={DEMO.BLANK_LINK}>gregory.johan@demo.com</a>
                  <p className="text-muted p-b-25 m-0 p-t-5 ">
                    Software Developer
                  </p>
                  <div className="contain-card p-t-30 p-b-10 ">
                    ...
                    <a href={DEMO.BLANK_LINK}>
                      <img
                        ...
                        title="Suzen"
                        alt=""
                        className="wid-40 img-radius m-l-5"
                      />
                    </a>
                    <a href={DEMO.BLANK_LINK}>
                      <img
              ...
              <div className="border-top bg-light">
                <Row className="m-0">
                  <Col
                    sm={6}
                    className="f-btn text-center border-right p-t-15 p-b-15 "
                  >
                    <a href={DEMO.BLANK_LINK}>
                      <i className="fas fa-envelope text-muted m-r-5" />
                      <p className="text-muted m-0 text-uppercase d-inline-block ">
                        Messages
                      </p>
                    </a>
                  </Col>
