        ...
        <Row>
          ...
          <Col md={6} xl={4}>
            <Card>
              ...
              <Card.Body className="card-power">
                <h2>7.3</h2>
                <span className="text-muted">m3</span>
          ...
          <Col md={12} xl={4}>
            <Card>
              ...
              <Card.Body className="card-power">
                <h2>7.3</h2>
                <span className="text-muted">mpg</span>
            ...
            <Card className="serve-card">
              ...
              <Card.Body>
                ...
                <div className="serve-text float-right">
                  <h4 className="d-inline-block m-r-15 f-18 text-muted">
                    Week
                  </h4>
                  <i className="fas fa-caret-down text-c-green f-20" />
                </div>
                <h6 className="text-muted">
                  Responded <span className="text-c-green">+40 </span>this week
                </h6>
            ...
            <Card className="invite-card">
              ...
              <Card.Body className="text-center">
                ...
                <p className="text-muted m-b-0">
                  You are close to your 528 invites goal
                </p>
              </Card.Body>
            </Card>
          </Col>
                  ...
                  <Col sm={6} className="b-r-default">
                    <Row className="status-rev-chart">
                      ...
                      <Col sm={6} className="text-right">
                        ...
                        <p className="text-muted f-16 d-inline-block f-w-400 m-l-10 m-b-0 ">
                          +1.6%
                        </p>
                      </Col>
                    </Row>
            ...
            <Card className="revenue-map">
              ...
              <Card.Body>
                <Row className="row">
                  <Col sm={8}>
                    <h2>$567</h2>
                    <span className="text-muted f-18 d-block">
                      January 2017
                    </span>
                    <p className="text-muted m-b-0 p-t-40">
                      Total tax deduction
                    </p>
              ...
              <Card.Body>
                <Row className="row">
                  <Col sm={6}>
                    ...
                    <p className="text-muted m-b-0 p-t-40">Total order</p>
                    <span className="m-l-5 f-w-400">2,567</span>
                  </Col>
