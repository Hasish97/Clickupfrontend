...
class BasicButton extends React.Component<{}, {}> {
  render() {
    ...
    const basicButtons = buttonVariants.map((variant, idx) => (
      <OverlayTrigger key={idx} overlay={<Tooltip id={"tooltip1"}>{variant}</Tooltip>}>
    ...
    const outlineButtons = buttonVariants.map((variant, idx) => (
      <OverlayTrigger
        key={idx}
        overlay={<Tooltip id="tooltip2">{"outline-" + variant}</Tooltip>}
      >
    ...
    const squareButtons = buttonVariants.map((variant, idx) => (
      <Button key={idx} className="btn-square" variant={variant}>
        <UcFirst text={variant} />
      </Button>
    ));
    const disabledButtons = buttonVariants.map((variant, idx) => (
      <Button key={idx} disabled variant={variant}>
        <UcFirst text={variant} />
      </Button>
    ));
    const roundedButtons = buttonVariants.map((variant, idx) => (
      <Button key={idx} className="btn-rounded" variant={variant}>
        <UcFirst text={variant} />
      </Button>
    ));
    const glowButtons = buttonVariants.map((variant, idx) => (
      <OverlayTrigger
        key={idx}
        overlay={<Tooltip id="tooltip3">{"btn-glow-" + variant}</Tooltip>}
      >
      ...
      <>
        ...
        <Row className="btn-page">
          <Col>
            <Card title="Default">
              <p>
                use <code>variant="*"</code> props in component{" "}
                <code>Button</code> to get various button
              </p>
              {basicButtons}
              <OverlayTrigger overlay={<Tooltip id="tooltip4">link</Tooltip>}>
                <Button variant="link">Link</Button>
              </OverlayTrigger>
            </Card>
            <Card title="Outline">
              <p>
                use <code>variant="outline-*"</code> props in component{" "}
                <code>Button</code> to get various outline button
              </p>
              {outlineButtons}
            </Card>
            <Card title="Square Button">
              <p>
                use <code>className="btn-square"</code> props in component{" "}
                <code>Button</code> to get square button
              </p>
              {squareButtons}
            </Card>
            <Card title="Disabled Button">
              <p>
                use <code>disabled</code> props in component <code>Button</code>{" "}
            ...
            <Card title="Rounded Button">
              <p>
                use <code>className="btn-rounded"</code> props in component{" "}
                <code>Button</code> to get rounded button
              </p>
              {roundedButtons}
            </Card>
            <Card title="Glow Button">
              <p>
                use <code>className="btn-glow"</code> props in component{" "}
                <code>Button</code> to get glow button
              </p>
              {glowButtons}
            </Card>
            <Card title="Shadow Button">
              <p>
                use <code>className=".shadow-[ 1 / 2 / 3 / 4 / 5 ]"</code> props
                in component <code>Button</code> to get shadow button
              </p>
              <OverlayTrigger overlay={<Tooltip id="tooltipShadow1">shadow-1</Tooltip>}>
                <Button className="shadow-1" variant="primary">
                  Shadow 1
                </Button>
              </OverlayTrigger>
              <OverlayTrigger overlay={<Tooltip id="tooltipShadow2">shadow-2</Tooltip>}>
                <Button className="shadow-2" variant="success">
                  Shadow 2
                </Button>
              </OverlayTrigger>
              <OverlayTrigger overlay={<Tooltip id="tooltipShadow3">shadow-3</Tooltip>}>
                <Button className="shadow-3" variant="danger">
                  Shadow 3
                </Button>
              </OverlayTrigger>
              <OverlayTrigger overlay={<Tooltip id="tooltipShadow4">shadow-4</Tooltip>}>
                <Button className="shadow-4" variant="warning">
                  Shadow 4
                </Button>
              </OverlayTrigger>
              <OverlayTrigger overlay={<Tooltip id="tooltipShadow5">shadow-5</Tooltip>}>
        ...
        <Row className="btn-page">
          <Col md={6}>
            <Card title="Sizes [ Large ]">
              <p>
                use <code>size="lg"</code> props in component{" "}
                <code>Button</code> to get large button
              </p>
          ...
          <Col md={6}>
            <Card title="Sizes [ Small ]">
              <p>
                use <code>size="sm"</code> props in component{" "}
                <code>Button</code> to get small button
              </p>
            ...
            <Card title="Button Toolbar Size">
              <Row>
                <Col xl={4} md={12}>
                  <p>
                    use <code>size="lg"</code> props in component{" "}
                    <code>ButtonGroup</code> to get large button toolbar
                  </p>
                  <ButtonGroup size="lg">
                    <Button variant="secondary">Left</Button>
                    <Button variant="secondary">Middle</Button>
                ...
                <Col xl={4} md={6}>
                  <p>
                    use <code>size="sm"</code> props in component{" "}
                    <code>ButtonGroup</code> to get small button toolbar
                  </p>
                  <ButtonGroup size="sm">
                    <Button variant="secondary">Left</Button>
                    <Button variant="secondary">Middle</Button>
