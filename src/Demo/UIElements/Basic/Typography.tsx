        ...
        <Row>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text className="text-muted mb-4">
                  Suspendisse vel quam malesuada, aliquet sem sit amet,
                  fringilla elit. Morbi tempor tincidunt tempor. Etiam id turpis
                  viverra, vulputate sapien nec, varius sem. Curabitur
                  ullamcorper fringilla eleifend. In ut eros hendrerit est
                  consequat posuere et at velit.
                </Card.Text>
                <h2>This is a Heading 2</h2>
                <Card.Text className="text-muted mb-4">
                  In nec rhoncus eros. Vestibulum eu mattis nisl. Quisque
                  viverra viverra magna nec pulvinar. Maecenas pellentesque
                  porta augue, consectetur facilisis diam porttitor sed.
                  Suspendisse tempor est sodales augue rutrum tincidunt. Quisque
                  a malesuada purus.
                </Card.Text>
                ...
                <Card.Text className="text-muted mb-4">
                  Nulla et mattis nunc. Curabitur scelerisque commodo
                  condimentum. Mauris blandit, velit a consectetur egestas, diam
                ...
                <Card.Text className="text-muted mb-4">
                  Donec ultricies, lacus id tempor condimentum, orci leo
                  faucibus sem, a molestie libero lectus ac justo. ultricies mi
                  eros, sit amet tempor nulla varius sed. Proin nisl nisi,
          ...
          <Col md={6}>
            <Card>
              ...
              <Card.Body>
                <Card.Text className="text-muted m-b-30">
                ...
                <Card.Text className="text-muted m-b-15 m-t-20">
                  Add <code>.text-right</code> for a blockquote with
