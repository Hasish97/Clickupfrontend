...
class BasicModals extends React.Component<{}, BasicModalsState> {
  state = {
    isBasic: false,
    isVertically: false,
    isTooltip: false,
              ...
              <Card.Body>
                ...
                >
                  ...
                  <Modal.Footer>
                    <Button
                      variant="secondary"
                      onClick={() => this.setState({ isVertically: false })}
                    >
                      Close
                    </Button>
                    <Button variant="primary">Save Changes</Button>
          ...
          <Col md={6} xl={4}>
            <Card>
              ...
              <Card.Body>
                <Button
                  variant="primary"
                  onClick={() => this.setState({ isTooltip: true })}
                >
                  Launch demo modal
                </Button>
                <Modal
                  show={this.state.isTooltip}
                  onHide={() => this.setState({ isTooltip: false })}
                >
                  <Modal.Header closeButton>
                    <Modal.Title as="h5">Modal Title</Modal.Title>
                  </Modal.Header>
                  <Modal.Body>
                    ...
                    <p>
                      This{" "}
                      <OverlayTrigger
                        overlay={<Tooltip id="tooltip_button_1">Tooltip Bottom</Tooltip>}
                      >
                    ...
                    <p>
                      This
                      <OverlayTrigger overlay={<Tooltip id="tooltip_button_2">Tooltip Lnk</Tooltip>}>
                  ...
                  <Modal.Footer>
                    <Button
                      variant="secondary"
                      onClick={() => this.setState({ isTooltip: false })}
                    >
                      Close
                    </Button>
                    <Button variant="primary">Save Changes</Button>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Modal
                  ...
                  onHide={() => this.setState({ isGrid: false })}
                >
                  <Modal.Header closeButton>
          ...
          <Col md={6} xl={4}>
            <Card>
              ...
              <Card.Body>
                <Button
                  variant="primary"
                  onClick={() => this.setState({ isScrolling: true })}
                >
                  Launch demo modal
                </Button>
                <Modal
                  show={this.state.isScrolling}
                  onHide={() => this.setState({ isScrolling: false })}
                >
                  <Modal.Header closeButton>
                    <Modal.Title as="h5">Modal Title</Modal.Title>
                  </Modal.Header>
                  ...
                  <Modal.Footer>
                    <Button
                      variant="secondary"
                      onClick={() => this.setState({ isScrolling: false })}
                    >
                      Close
                    </Button>
                    <Button variant="primary">Save Changes</Button>
          ...
          <Col md={6} xl={4}>
            <Card>
              ...
              <Card.Body>
                <Button
                  variant="primary"
                  onClick={() => this.setState({ isSmall: true })}
                >
                  Small modal
                </Button>
                <Modal
                  ...
                  onHide={() => this.setState({ isSmall: false })}
                >
                  <Modal.Header closeButton>
            ...
            <Card>
              ...
              <Card.Body className="btn-page">
                <Button
                  variant="primary"
                  onClick={() =>
                    this.setState({ isVarying: true, title: "@mdo" })
                  }
                >
                  Open modal for @mdo
                </Button>
                <Button
                  variant="primary"
                  onClick={() =>
                    this.setState({ isVarying: true, title: "@fat" })
                  }
                >
                  Open modal for @fat
                </Button>
                <Button
                  variant="primary"
                  onClick={() =>
                    this.setState({ isVarying: true, title: "@bootstrap" })
                  }
                >
                ...
                >
                  <Modal.Header closeButton>
                    <Modal.Title as="h5">
                      New message to {this.state.title}
                    </Modal.Title>
                  </Modal.Header>
                  <Modal.Body>
                    <Form>
