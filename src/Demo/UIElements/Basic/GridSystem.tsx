          ...
          <Col>
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  ...
                  default responsive tiers, Sass variables and mixins, and
            ...
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  ...
                  because the viewport width is in pixels and does not change
                  with the{" "}
                  <a
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  <code className="highlighter-rouge">xl</code>. Add any number
                  of unit-less classes for each breakpoint you need and every
                ...
                <hr />
                <Card.Text>
                  Equal-width columns can be broken into multiple lines, but
                  there was a{" "}
                  <a
                ...
                <Card.Text>
                  ...
                  inserting a <code className="highlighter-rouge">.w-100</code>{" "}
                  where you want the columns to break to a new line. Make the
                  breaks responsive by mixing the{" "}
                  <code className="hlighter-rouge">.w-100</code> with some{" "}
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <hr />
                <Card.Text>
                  The <code>Col</code> lets you specify column widths across 5
                  breakpoint sizes (xs, sm, md, large, and xl).
                </Card.Text>
                <div className="bd-example-row">
                  <Container>
                    <Row>
                ...
                <hr />
                <Card.Text>
                  For every breakpoint, you can specify the amount of columns to
                  span, or set the prop to <code>Col with lg=true</code> for
                  auto layout widths.
                </Card.Text>
                <div className="bd-example-row">
                  <Container>
            ...
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  {" "}
                  The <code>Col</code> breakpoint props also have a more
                  complicated <code>object</code> prop form:{" "}
                  <code>{`{span: number, order: number, offset: number}`}</code>{" "}
                  for specifying offsets and ordering affects.{" "}
                </Card.Text>
                <Card.Text>
                  You can use the <code>`order`</code> property to control the{" "}
                  <code>visual order</code> of your content.
                </Card.Text>
                <div className="bd-example-row">
                  <Container>
                    <Row>
            ...
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  ...
                  <code>`offset`</code> value, or, for more general layout, use
                  the margin class utilities.
                </Card.Text>
                <div className="bd-example-row">
                  <Container>
                    <Row>
