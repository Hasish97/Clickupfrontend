...
class BasicCollapse extends Component<{}, BasicCollapseState> {
  state = {
    isBasic: false,
    isMultiTarget: [] as string[],
    accordionKey: 1
  };
  targetHandler = (target: string) => {
        ...
        <Row className="btn-page">
          ...
          <Col sm={12}>
            ...
            <Button
              ...
              aria-expanded={isMultiTarget.some(target => target === "target1")}
            >
            ...
            <Button
              ...
              aria-expanded={isMultiTarget.some(target => target === "target2")}
            >
