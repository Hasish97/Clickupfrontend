...
function callbackButtonPNotify() {
  const dontAlert = function(str: string) {};
  PNotify.notice({
    title: "I'm Here",
    text:
    ...
    modules: {
      Callbacks: {
        beforeInit: function(opts: { text: string }) {
          dontAlert(
        ...
        afterInit: function(notice: string) {
          dontAlert(
        ...
        afterClose: function(notice: string, timerHide: string) {
          dontAlert(
...
function progressButtonPNotify() {
  ...
  const loader = PNotify.notice({
    ...
    modules: {
      ...
      Callbacks: {
        beforeOpen: function(notice: any) {
          // @ts-ignore
...
function multiLinePNotify() {
  ...
  notice.on("pnotify.confirm", function(e: any) {
  ...
  notice.on("pnotify.cancel", function(e: any) {
    notice.cancelClose().update({
          ...
          <Col>
                ...
                <Table responsive>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        Use method <code>success</code> with{" "}
                        <code>PNotify</code>
                      </td>
                    </tr>
                    <tr>
            ...
            <Card>
              ...
              <Card.Body className="btn-page">
                <Card.Text>
                  Use variant method from notification alert and set{" "}
                  <code>option</code> like,{" "}
                  <code>{"modules:{ Desktop: { desktop: true}}"}</code> with{" "}
                  <code>PNotify</code>
                </Card.Text>
                ...
                <Table responsive>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        Set <code>option</code> like,{" "}
                        <code>{"title:false, icon: false"}</code> with{" "}
                        <code>PNotify</code>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        Set <code>function</code> like,{" "}
                        <code>closeOnClickPNotify</code>
                      </td>
                    </tr>
                    <tr>
                      <td>Custom Button</td>
                    ...
                    <tr>
                      ...
                      <td>
                        Set <code>function</code> like,{" "}
                        <code>callbackButtonPNotify</code>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        Set <code>function</code> like,{" "}
                        <code>progressButtonPNotify</code>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        Set <code>function</code> like,{" "}
                        <code>dynamicProgressButtonPNotify</code>
                      </td>
                    </tr>
                    <tr>
