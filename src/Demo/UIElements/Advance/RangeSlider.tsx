        ...
        <Row>
          ...
          <Col sm={12} md={6} xl={4}>
            <Card>
              <Card.Header>
                <Card.Title as="h5">
                  Range with <code>controller</code>,{" "}
                  <code>allowCross=false</code>, <code>pushable={"{5}"}</code>
                </Card.Title>
              </Card.Header>
              <Card.Body>
          ...
          <Col sm={12} md={6} xl={4}>
            <Card>
              <Card.Header>
                <Card.Title as="h5">
                  Multi Range with <code>trackStyle</code>,{" "}
                  <code>handleStyle</code>, <code>railStyle</code>
                </Card.Title>
              </Card.Header>
              <Card.Body>
                <Range
          ...
          <Col sm={12} md={6} xl={4}>
            <Card>
              <Card.Header>
                <Card.Title as="h5">
                  Slider with <code>className</code> like{" "}
                  <code>square-handler</code>, <code>triangle-handler</code>
                </Card.Title>
              </Card.Header>
              <Card.Body>
                <Slider
            ...
            <Card>
              ...
              <Card.Body>
                <Slider
                  ...
                  handleStyle={
                    { backgroundColor: "#fb0000", borderColor: "#fb0000" }
                  }
                />
                <hr />
                <Slider
...
type ControlledRangeDisableAcrossState = {
  value?: number[]
...
class ControlledRangeDisableAcross extends React.Component<
  {pushable?: boolean},
  ControlledRangeDisableAcrossState
> {
  constructor(props: {}) {
    super(props);
    this.state = {
