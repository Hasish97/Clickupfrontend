...
type AdvanceRatingState = {
  horizontalRating?: any,
  reverseRating?: any,
  movieRating?: any,
  fractionalRating?: any,
  featherRating?: any,
  squareRating?: any,
  pillRating?: any,
  blockRating?: any
};
class AdvanceRating extends React.Component<{}, AdvanceRatingState> {
  state = {
    blockRating: 7,
    movieRating: 1,
    squareRating: 3,
        ...
        <Row>
          <Col sm={12} md={6} xl={4}>
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  Use <code>className='theme-bar-block'</code> with component{" "}
                  <code>Rating</code> to see default rating.
                </Card.Text>
                <Rating
                  stop={10}
                  ...
                  onHover={(rate) => {
                    ...
                    if (blockRatinggDom) {
                      (blockRatinggDom as HTMLDivElement).innerHTML = `${rate || this.state.blockRating}`;
                    }
                  }}
                />
                <span id="block-rating" className="current-rating-block">
                  {this.state.blockRating}
                </span>
              </Card.Body>
            </Card>
          </Col>
          <Col sm={12} md={6} xl={4}>
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  Use <code>className='theme-bar-pill'</code> with component{" "}
                  <code>Rating</code> to see pill rating.
                </Card.Text>
          ...
          <Col sm={12} md={6} xl={4}>
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  Use <code>className='theme-bar-square'</code> with component{" "}
                  <code>Rating</code> to see square rating.
                </Card.Text>
                <Rating
          ...
          <Col sm={12} md={6} xl={4}>
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  Use font-awesome icons in <code>emptySymbol</code> and{" "}
                  <code>fullSymbol</code> with component <code>Rating</code> to
                  see font awesome rating.
                </Card.Text>
                <Rating
          ...
          <Col sm={12} md={6} xl={4}>
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  Use feather icons in <code>emptySymbol</code> and{" "}
                  <code>fullSymbol</code> with component <code>Rating</code> to
                  see feather rating.
                </Card.Text>
                <Rating
          ...
          <Col sm={12} md={6} xl={4}>
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  Use <code>fractions</code> with component <code>Rating</code>{" "}
                  to see fractions rating.
                </Card.Text>
                  ...
                  <Rating
                    ...
                    onHover={(rate) => {
                      ...
                      if (fractionalRatingDom) {
                        fractionalRatingDom.innerHTML = `${rate || this.state.fractionalRating}`;
                      }
                    }}
                  />
                </div>
                <Card.Text>
                  Your Rating is :{" "}
                  <span id="fractional-rating">
                    {this.state.fractionalRating}
                  </span>
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col sm={12} md={6} xl={4}>
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  Use <code>className='theme-bar-movie'</code> with component{" "}
                  <code>Rating</code> to see movie rating.
                </Card.Text>
                <Rating
                  stop={4}
          ...
          <Col sm={12} md={6} xl={4}>
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  Use <code>className='theme-bar-reverse'</code> with component{" "}
                  <code>Rating</code> to see reverse rating.
                </Card.Text>
          ...
          <Col sm={12} md={6} xl={4}>
            <Card>
              ...
              <Card.Body>
                <Card.Text>
                  Use <code>className='theme-bar-horizontal'</code> with
                  component <code>Rating</code> to see horizontal rating.
                </Card.Text>
                  ...
                  <Rating
                    ...
                    onHover={(rate) => {
                      ...
                      if (horizontalRatingDom)
                        (horizontalRatingDom as HTMLDivElement).innerHTML = `${rate || this.state.horizontalRating}`;
                    }}
                  />
                </div>
                <div
