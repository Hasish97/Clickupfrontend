...
class AdvanceTree extends React.Component<{}, {}> {
  render() {
    const typeFolder = (
      <i className="fa fa-folder-open fa-2x text-warning align-middle" />
    );
    const typeFolderClose = (
      <i className="fa fa-folder fa-2x text-warning align-middle" />
    );
    const typeHtml5 = (
      <i className="fa fa-html5 fa-2x text-danger align-middle" />
    );
    const typePdf = (
      <i className="fa fa-file-pdf-o fa-2x text-info align-middle" />
    );
    ...
    const typeImage = (
      <i className="fa fa-file-image-o fa-2x text-primary align-middle" />
    );
    const typeZip = (
      <i className="fa fa-file-archive-o fa-2x text-info align-middle" />
    );
          ...
          <Col sm={12} md={6} xl={4}>
            <Card>
              ...
              <Card.Body>
                ...
                />
                <Card.Text>
                  Theme: <code>classic(default)</code>, <code>metro</code>,{" "}
                  <code>moonlight</code>, <code>purple</code>,{" "}
