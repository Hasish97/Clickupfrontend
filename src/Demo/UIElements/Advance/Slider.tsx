...
class AdvanceSlider extends React.Component<{}, {}> {
  ...
  render() {
    ...
    const settingsNavButtonDots = {
      ...
      customPaging: (i: number) => <div className="pc-dot">{i + 1}</div>
    };
    return (
      <>
        ...
        <Row>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <div className="mt-5 text-center">
                  <Button size="sm" onClick={this.previous}>
                    Previous
                  </Button>
            ...
            <Card>
              ...
              <Card.Body>
                ...
                <div className="text-center">
                  <Button size="sm" onClick={this.previousNav}>
                    <i className="feather icon-chevron-left m-0" />
                  </Button>
                  <Button size="sm" onClick={this.nextNav}>
          ...
          <Col sm={12}>
            <Card>
              <Card.Header>
                <Card.Title as="h5">
                  Multi-Items with Responsive Slider
                </Card.Title>
              </Card.Header>
              <Card.Body>
