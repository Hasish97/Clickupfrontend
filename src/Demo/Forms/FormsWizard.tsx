  ...
  return (
    <div className="sw-container tab-content">
      <div className="step-content">
        ...
        <h6>Sub title 1</h6>
        <p>
          <strong>@Title content 1!.. </strong> Lorem Ipsum is simply dummy text
          of the printing <strong>@Content content 1 </strong> and typesetting
          industry. Lorem Ipsum has been the industry's standard dummy text.
        </p>
        <h6 className="mt-3">Sub title 2</h6>
        <p>
          <strong>@Title content 2!.. </strong> Lorem Ipsum is simply dummy text
...
type FormsWizardState = {
  isFinished?: boolean
};
class FormsWizard extends React.Component<{}, FormsWizardState> {
  state = {
    isFinished: false
  };
  customRenderer = ({
  ...
  customComponents = ({ currentStep }: { currentStep: number }) => {
