...
type FormsElementsState = {
  validated?: boolean,
  validatedTooltip?: boolean,
  supportedSelect?: number,
  supportedFile?: boolean,
  supportedRadio?: boolean,
  supportedCheckbox?: boolean
};
class FormsElements extends React.Component<{}, FormsElementsState> {
  state = {
    validated: false,
  ...
  handleSubmitTooltip(event: React.FormEvent) {
    const form = event.currentTarget;
    if (!(form as HTMLFormElement).checkValidity()) {
      event.preventDefault();
      event.stopPropagation();
  ...
  supportedSelectHandler = (event: React.ChangeEvent<HTMLInputElement>) => {
    this.setState({ supportedSelect: parseInt(event.target.value) });
  };
  supportedFileHandler = (event: React.ChangeEvent<HTMLInputElement>) => {
                  ...
                  <Col>
                    ...
                    <Form.Group className="mt-3">
                      <Form.Control
                        ...
                        onChange={(event: any) => this.supportedSelectHandler(event)}
                      >
                    ...
                    <div className="custom-file">
                      <Form.Control
                        ...
                        onChange={(event: any) => this.supportedFileHandler(event)}
                      />
                      <Form.Label
                ...
                <Row>
                  <Col>
                    <Form noValidate validated={validatedTooltip}>
                      ...
                      <Button onClick={e => this.handleSubmitTooltip(e)}>
                        Submit form
                      </Button>
                    </Form>
                  </Col>
