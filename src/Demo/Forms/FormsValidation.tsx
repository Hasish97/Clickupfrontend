...
interface MaskWithValidationProps {
  name: string;
  id: string;
  placeholder: string;
  className: string;
...
class MaskWithValidation extends BaseFormControl<MaskWithValidationProps, {}> {
  checkError: any;
...
type FormsValidationState = {
  ...
  custom?: string,
  basic?: string,
  checkMeSwitch?: boolean,
  confirmPassword?: string
};
class FormsValidation extends React.Component<{}, FormsValidationState> {
  state = {
    firstName: "",
    lastName: "",
    email: "",
  ...
  handleCheckboxChange = (e: React.ChangeEvent<HTMLInputElement>, value: string) => {
    this.setState({
      [e.target.name]: value
    });
  };
  ...
  handleSubmit = (e: React.FormEvent, formData: any, inputs: any) => {
    e.preventDefault();
                  ...
                  <Form.Row>
                    ...
                    <Form.Group as={Col} md="6">
                      ...
                      <MaskWithValidation
                        ...
                        required
                        validator={(value:string) => value === "(123) 456-7890"}
                ...
                >
                  <Card>
                    ...
                    <Card.Body>
                      <ul>
                        <li>
                          <strong>Full Name:</strong> {this.state.firstName}{" "}
                          {this.state.lastName}
                        </li>
                        <li>
                        ...
                        <li>
                          <strong>Website:</strong> {this.state.url}
                        </li>
                        <li>
                          <strong>Gear:</strong> {this.state.gear}
                        </li>
                        <li>
                          <strong>About:</strong> {this.state.description}
                        </li>
                      </ul>
                    </Card.Body>
