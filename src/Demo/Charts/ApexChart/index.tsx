...
type ApexChartState = {
  ...
  dailyVisitor: {
    ...
    options: {
      ...
      markers: { size: number, style: string },
      colors: string[],
      xaxis: { type: string, min: number, tickAmount: number, labels: any },
      grid: any,
      yaxis: any,
      tooltip: any,
      fill: any
...
class ApexChart extends React.Component<{}, ApexChartState> {
  mainInterval: any = undefined;
  subInterval: any = undefined;
  // @ts-ignore
  state = {
  ...
  dailyVisitorHandler = (unit: string ) => {
    let minState: number | undefined;
    let maxState: number | undefined;
    switch (unit) {
      case "1m":
  ...
  getDayWiseTimeSeries(baseval: number, count: number, yrange: { max: number; min: number }) {
    let i = 0;
    let newData: any[] = [];
    let newDate;
    while (i < count) {
                ...
                <ButtonToolbar>
                  ...
                  >
                    <ToggleButton
                      ...
                      value="1m"
                      size="sm"
                      onClick={() => this.dailyVisitorHandler("1m")}
                    >
                      1M
                    </ToggleButton>
                    <ToggleButton
                      ...
                      value="6m"
                      size="sm"
                      onClick={() => this.dailyVisitorHandler("6m")}
                    >
                      6M
                    </ToggleButton>
                    <ToggleButton
                      ...
                      value="1y"
                      size="sm"
                      onClick={() => this.dailyVisitorHandler("1y")}
                    >
                      1Y
                    </ToggleButton>
                    <ToggleButton
                      ...
                      value="ytd"
                      size="sm"
                      onClick={() => this.dailyVisitorHandler("ytd")}
                    >
                      YTD
                    </ToggleButton>
                    <ToggleButton
                      ...
                      value="all"
                      size="sm"
                      onClick={() => this.dailyVisitorHandler("all")}
                    >
                      All
                    </ToggleButton>
                  </ToggleButtonGroup
