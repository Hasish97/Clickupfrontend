...
import img405 from "../../assets/images/auth/405.png";
          ...
          <div className="auth-content container">
            <div className="row align-items-center">
              <div className="col-sm-6">
                <img src={img405} alt="" className="img-fluid mb-4" />
              </div>
              <div className="col-sm-6">
                ...
                <h2 className="font-weight-bolder">Not Allowed</h2>
                <h5 className="mb-4">
                  The requested method is not allowed for a given resource
                </h5>
