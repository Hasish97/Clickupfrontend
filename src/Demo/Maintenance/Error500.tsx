...
import img500 from "../../assets/images/auth/500.png";
          ...
          <div className="auth-content container">
            <div className="row align-items-center">
              <div className="col-sm-6">
                <img src={img500} alt="" className="img-fluid mb-4" />
              </div>
              <div className="col-sm-6">
                <img src={logoDark} alt="" className="img-fluid mb-4" />
                <h1 className="text-primary display-1 font-weight-bolder">
                  500
                </h1>
                <h2 className="font-weight-bolder">Internal Server Error</h2>
                <h5 className="mb-4">Something went wrong with server</h5>
                <button className="btn btn-primary mb-4 rounded-pill">
                  Go back
                </button>
              </div>
            </div>
