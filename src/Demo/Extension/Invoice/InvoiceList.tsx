...
type InvoiceListState = {
  activateCollapse?: number[],
  findIndex?: (
    predicate: (value: number, index: number, obj: number[]) => unknown,
    thisArg?: any
  ) => number
};
class InvoiceList extends React.Component<{}, InvoiceListState> {
  state = {
    activateCollapse: [1, 2, 3]
  };
  collapseHandler = (activeKey: number) => {
    if (
      this.state.activateCollapse.findIndex(item => item === activeKey) > -1
    ) {
      this.setState({
        activateCollapse: this.state.activateCollapse.filter(item => item !== activeKey)
      });
    } else {
      this.setState(prevState => {
        return {
          activateCollapse: [...prevState.activateCollapse, activeKey]
        };
      });
    }
  };
            ...
            <Card className="task-board-left">
              ...
              <Card.Body>
                ...
                <div className="task-right">
                  ...
                  <Collapse
                    in={activateCollapse.findIndex(item => item === 1) > -1}
                  >
                    <div
                  ...
                  <Collapse
                    in={activateCollapse.findIndex(item => item === 2) > -1}
                  >
                    <div
                  ...
                  <Collapse
                    in={activateCollapse.findIndex(item => item === 3) > -1}
                  >
                    <div
                    ...
                    >
                      <div className="media">
                        ...
                        <div className="media-body">
                          ...
                          <p className="chat-header  text-muted">
                            4 minutes ago
                          </p>
                        </div>
                      </div>
                ...
                <Card className="card-border-c-blue">
                  ...
                  <Card.Body className="card-task">
                    <Card.Text className="task-detail">
                      ...
                      table One morning, when Gregor Samsa woke from troubled.
                    </Card.Text>
              ...
              <Col md={6}>
                <Card className="card-border-c-red">
                  <Card.Header>
                    ...
                    <span className="label label-danger float-right">
                      {" "}
                      28 January, 2015{" "}
                    </span>
                  </Card.Header>
