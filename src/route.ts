...
//   import("./Demo/Authentication/ResetPassword/ResetPassword1")
// );
// const ChangePassword = React.lazy(() =>
//   import("./Demo/Authentication/ChangePassword")
// );
...
const route: RouteObject[] = [
    {path:"/login",exact:true,name:"demo",component:Login}
  ...
  // },
  // {
  //   path: "/maintenance/error-403",
  //   exact: true,
  //   name: "Error 403",
  //   component: Error403
  // },
  // {
  //   path: "/maintenance/error-404",
  //   exact: true,
  //   name: "Error 403",
  //   component: Error404
  // },
  // {
  //   path: "/maintenance/error-405",
  //   exact: true,
  //   name: "Error 403",
  //   component: Error405
  // },
  // {
  //   path: "/maintenance/error-500",
  //   exact: true,
  //   name: "Error 403",
  //   component: Error500
  // },
