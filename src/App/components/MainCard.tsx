...
interface IMainCardProps extends React.HTMLAttributes<Element> {
  isOption?: boolean;
  cardClass?: any;
  title?: any;
  windowWidth: number;
...
class MainCard extends Component<IMainCardProps, MainCardState> {
  state = {
  ...
  render() {
    let fullScreenStyle: React.CSSProperties = {};
...
export default (windowSize(MainCard as any) as any);
