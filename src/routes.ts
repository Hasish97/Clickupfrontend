...
// const DashboardShop = React.lazy(() => import('./Demo/Dashboard/Shop'));
// const StatisticsProject = React.lazy(() => import('./Demo/Dashboard/StatisticsProject'));
// const DetailsProject = React.lazy(() => import('./Demo/Dashboard/DetailsProject'));
// const TaskManagerProject = React.lazy(() => import('./Demo/Dashboard/TaskManagerProject'));
// const MembersProject = React.lazy(() => import('./Demo/Dashboard/MembersProject'));
// const Server = React.lazy(() => import('./Demo/Dashboard/Server'));
...
const Login = React.lazy(() => import('./pages/clickup/login/Login'));
const Projects=React.lazy(()=>import('./pages/clickup/spaces/Projects'));
const Report=React.lazy(()=>import('./pages/clickup/reports/Reports'));
const Employees=React.lazy(()=>import('./pages/clickup/employees/Employees'));
const Spaces=React.lazy(()=>import('./pages/clickup/spaces/Spaces'));
const Home=React.lazy(()=>import('./pages/clickup/home/Home'));

const routes = [
    { path: '/', exact: true, name: 'login', component: Login },
    { path: '/space/:id',  exact: true, name: 'main', component: Projects},
    { path: '/spaces',  exact: true, name: 'main', component: Spaces},
    ...
    // { path: '/dashboard/server', exact: true, name: 'Crypto', component: Server },
    // {
    ...
    // },
    // {
    //     path: '/dashboard/project/task-manager',
    //     exact: true,
    //     name: 'Crypto',
